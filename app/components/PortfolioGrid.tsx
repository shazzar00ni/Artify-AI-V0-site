...
const projects = [
  {
    ...
    description: "Personalized AI-generated portraits with customizable styles and features",
  ...
  },
  {
    ...
    description: "Transform your photos into the style of famous artists using our neural networks",
  ...
  },
  {
    ...
    description: "Multi-user AI art creation platform for teams and communities",
    imageUrl: "/placeholder.svg?height=600&width=800",
  ...
  },
  {
    ...
    description: "Convert your written descriptions into detailed visual artwork",
    imageUrl: "/placeholder.svg?height=800&width=600",
  ...
  },
  {
    ...
    description: "Create stunning animations from static images using our AI motion engine",
    imageUrl: "/placeholder.svg?height=600&width=800",
    category: "Animation",
  },
  {
    ...
    description: "Generate, mint, and sell your AI artwork as NFTs with our integrated platform",
    imageUrl: "/placeholder.svg?height=800&width=600",
    category: "NFT",
  },
]
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="mt-4 text-lg text-muted-foreground">
            A showcase of our AI-powered creations and innovative solutions.
          </p>
        </motion.div>
